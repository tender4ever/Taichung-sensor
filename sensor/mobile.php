...
?>
  <a href="mobile.php"><img src="123.png" width="35" height="35" /></a></p>
  <hr />
  <?php do { ?>
    <p align="left">位置:<?php echo $row_Recordset2['site']; ?><a href="search.php"> 歷史查詢</a></p>
    <p>
      <iframe src="main1.php?sensor_id=<?php echo $row_Recordset2['sensor_id'];?>" width="400" height="200" scrolling="no" frameborder="0"> </iframe>
      &nbsp; </p>
    <hr />
