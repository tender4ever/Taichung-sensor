...
$query_Recordset1 = sprintf("SELECT * FROM sensing WHERE sensor_id = %s ORDER BY sensing_id DESC", GetSQLValueString($colname_Recordset1, "int"));
...
mysql_select_db($database_sensor, $sensor);
$query_Recordset2 = sprintf("SELECT * FROM sensor WHERE sensor_id = %s", GetSQLValueString($colname_Recordset2, "int"));
...
<?php } else header ("Refresh: 5;main1.php?sensor_id=$colname_Recordset1")?>
